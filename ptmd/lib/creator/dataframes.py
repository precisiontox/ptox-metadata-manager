...
def add_blanks_to_sample_dataframe(
    ...
    for blank in range(1, replicate_blank + 1):
        ...
        series = Series([hash_id, f'{BASE_IDENTIFIER}{BLANK_CODE}', *EMPTY_FIELDS_VALUES, blank, 'EXTRACTION BLANK', "0", 'TP0', 0],
